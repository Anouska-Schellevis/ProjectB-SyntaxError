...
class Theater300
{
    ...
    static void DisplaySeats(long showId)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            ...
            for (int j = 0; j < columns; j++)
            {
                ...
                else
                {
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.DarkGreen;  // Gray for chosen seat
                        Console.Write("■   ");
                    }
                }
            }
    ...
    public void SelectSeats(long showId)
    {
        ...
        if (currentUser != null)
        {
            MakeReservation(selectedSeats, currentUser, showId); // Pass the current user model to MakeReservation
        }
    }
    ...
    private void MakeReservation(List<SeatsModel> selectedSeats, UserModel currentUser, long showId)
    {
        ...
        foreach (var seat in selectedSeats)
        {
            ...
            var reservation = new ReservationModel
            {
                ...
                Bar = barService,
                SeatsId = (int)seat.Id, // Calculate seat ID
